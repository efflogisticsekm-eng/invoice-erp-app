...
export default function PettyCash({ user, onBack }) {
  ...
  const handleSubmit = async (e) => {
    ...
    // Construct extra details JSON to store dynamic fields
    const extraDetails = {};
  ...
  const needsVehicleNumber = ["Vehicle Maintenance", "Vehicle Statutory Exp", "Fines", "Fast Tag Recharge"].includes(formData.head) || formData.subhead === "Petrol Expense";
...
console.log('Done writing PettyCash.jsx');
