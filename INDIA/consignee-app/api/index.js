...
app.get('/api/explorer/data/:table', async (req, res) => {
  ...
  if (!['live_scanned_invoices', 'all_invoices', 'pod_register', 'supervisor_branch_mapping', 'holidays', 'customer_branch_mapping', 'unloading_master', 'vehicle_master'].includes(table)) {
